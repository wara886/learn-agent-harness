...
当前五课中的 DeepSeek Harness 产品事实固定到 `b150a551b8d465e31e418e1b2eaf5e79bbb7d28e`，五课 Pi 对照固定到 `earendil-works/pi@c49906ec77788625aacbdc53ebca6fbe65bd20f5`。教学状态机是概念演示，不是两个上游项目的 API，也不保证真实模型采取相同决策。
