...
> 更新日期：2026-08-23
> 分支：`codex/pi-three-lesson-track`
> 当前阶段：双轨六课 beta 完成，M4 真人测试待执行
...
| 课程内容 | 3 个 DSH 课程、3 个 Pi 课程、6 个 DSH claims、3 个 Pi claims、双上游固定提交链接 | `src/domain/lessons.ts`、`src/domain/claims.ts` |
...
- Playwright 覆盖 DSH 三课与 Pi 三课主流程、完整桌面目录、移动目录切换、搜索、刷新恢复、清除、390 px 首屏、键盘、axe 和无远程资源请求。
- production build 首屏 JavaScript 为 `108.44 kB gzip`，低于 `180 KiB` 预算。
